...
public class StatisticsOfEmp {

	public static void main(String[] args) {
		StatisticsOfEmp obj = new StatisticsOfEmp();
		
		obj.addEmployees(obj);
	}
		
		public void addEmployees(StatisticsOfEmp obj) {
		...
		public void statisticsOfEmp(List<Employee> listOfEmp) {
			Map<Integer, DoubleSummaryStatistics> statistics= listOfEmp.stream().collect(Collectors.groupingBy(Employee::getDeptId, Collectors.summarizingDouble(Employee::getSalary)));
			...
			//to only get the max salary of 102
			double maxSalary = statistics.get(102).getMax();

			System.out.println("Max salary of 102:: "+maxSalary);
		}
}
